...
export default class DiscountSummary extends Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: false,
      ...
      discounts_tableData: [
        ['0', 'SGD 0.00', 'SGD 0.00', 'SGD 0.00', 'SGD 0.00'],
      ],
      services_col: ['Discount', 'Total'],
      services_tableHead: [
        'Items Discounted',
        'Items Value',
        'Discount Amount',
  ...
  renderSideMenuContent = () => {
    ...
    let vouchers = [
      {value: 'Include redemptions'},
      {value: 'Exclude redemptions'},
    ];
  ...
  renderMainContent = () => {
    const {col, tableHead, tableData} = this.state;
    const win = Dimensions.get('window');
    const ww = win.width / 4;
    return (
      <SafeAreaView
