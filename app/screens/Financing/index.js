...
import {FlatList, View, TextInput, Image, ScrollView} from 'react-native';
        ...
        <ScrollView style={styles.container}>
          <View style={styles.logoWrapper}>
            ...
            <View style={[styles.inputGroup, styles.contentCenter]}>
              ...
              <Text
                header
                bold
                style={{color: GreenColor.darkPrimaryColor, marginTop: 0}}>
                $50,000
              </Text>
          ...
          <View
            ...
            <View style={[styles.contentCenter, {flexDirection: 'column'}]}>
              <Icon name="file-alt" size={60} color={BaseColor.blackColor} />
          ...
          <View style={[styles.contentBetween, {marginTop: 30}]}>
            ...
            <Text footnote numberOfLines={5} style={{paddingHorizontal: 10}}>
              I have read, understood and agreed to be subjected to Vaniday's Privacy and Policy and I consent for Vaniday to disclose my personal data to any third parties and / or any of their respective agents for purpose of loan application.
            </Text>
          </View>
        </ScrollView>
