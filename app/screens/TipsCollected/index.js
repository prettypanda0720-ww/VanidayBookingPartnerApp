...
export default class TipsCollected extends Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: false,
      ...
      modalVisible: false,
      col: ['Date', 'Total'],
      tableHead: ['Invoice No.', 'Location', 'Staff Name', 'TipsCollected'],
      tableData: [['', '', '', 'SGD 0.00']],
    };
  }
  ...
  renderSideMenuContent = () => {
    let location = [{value: 'All locations'}, {value: 'Makeup Artist'}];
